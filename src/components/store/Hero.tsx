      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 md:py-20">
        <div className="animate-in-up">
          <span className="inline-flex items-center gap-2 rounded-md border border-stoka-border bg-stoka-surface px-3 py-1.5 text-xs font-semibold text-stoka-ink shadow-card">
            ...
            Envío gratis desde S/ 60 en tu zona
          </span>
          <h1 className="mt-5 font-display text-5xl font-bold leading-[0.95] text-stoka-ink sm:text-6xl lg:text-7xl">
            Tu tienda,
            <br />
            <span className="text-stoka-red">más simple.</span>
          </h1>
          <p className="mt-5 max-w-md text-base text-stoka-ink-muted sm:text-lg">
            Tu bodega de confianza, ahora también online. Abarrotes, bebidas, frescos y más,
            con delivery rápido a tu puerta.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            <Link to="/catalogo" className={buttonVariants("primary", "lg")}>
              Comprar ahora <ArrowRight className="size-4" aria-hidden="true" />
            </Link>
          ...
          <div className="mt-8 flex flex-wrap gap-5 text-sm font-semibold text-stoka-ink-muted">
            <span className="flex items-center gap-2">
              <Truck className="size-4 text-stoka-red" aria-hidden="true" /> Delivery el mismo día
            </span>
            <span className="flex items-center gap-2">
              <ShieldCheck className="size-4 text-stoka-red" aria-hidden="true" /> Pago seguro y verificado
            </span>
          </div>
        </div>
